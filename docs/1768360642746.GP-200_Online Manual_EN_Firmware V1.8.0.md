...
## Main Display Screen ·············································6
TUNER ···········································································6
LOOPER ·········································································7
DRUM ·············································································8
MIDI Device Control Functions (MIDI) ·········8
EXP Pedal ····································································9
## Patch Setting ····································9
## Edit Menu ····································································9
Editing a Module ···················································10
Managing the Signal Chain ·····························10
## Patch Settings ························································10
## Save Menu ·································································12
## Global Settings ·································12
Input/Output ·····························································13
...
With full-range speaker devices ·················22
With guitar amps (INPUT jack) ·····················22
With  guitar  amps  (using  FX  Loop  to  pre-
position the GP-200) ·········································23
With  guitar  amps  (using  FX  Loop  to  post-
position the GP-200) ·········································23
With  guitar  amps  (using  FX  Loop  to  run
the 4 cable method) ···········································24
Audio Studio (for livestreaming) ·················24
## Effect List ········································25
PRE ···············································································25
WAH ··············································································31
DST ···············································································32
...
RVB ··············································································67
VOL ···············································································69
SnapTone Function ···························70
## Drum Rhythm List ····························71
MIDI Control Information List         ····74
## Troubleshooting  ·······························77
...
## 12
-     LCD Display
4.3” color LCD shows GP-200’s patch numbers,
patch name, and other operation information.
- PARA Knob (with enter button)
Turn to select menus and adjust parameters
-  MASTER Knob
Turn to control GP-200’s main output volume.
- BACK Button
Press to return to the previous page, hold to
return to the main display screen.
-  GLOBAL Button
Press to enter the Global Setting menu, where
you can edit the global parameters of the GP-
## 200.
-  DRUM Button
Press to play the drum. Hold to enter the Drum
Machine Edit menu, where you can edit the
drum parameters (style, rhythm, volume).
-     SAVE Button
...
button again to store the changed parameter.
Hold for quick saving in same slot with same
name.
-  AMP Knobs
Control the AMP module in real time just like a
real amp.
## 9.  Module Buttons
Press to enter the Edit Settings menu of module,
hold for module on/off.
## 10. Quick Access Knobs
Turn to adjust parameters on the lower part
of the screen. Each knob will vary in function
according to the parameter on the display.
## 11.  8 Footswitches
Use to change patches, turn on/off effects, set
tap tempo, etc.
## 12. Expression Pedal
Use to control one or several parameters of
selected module(s).
...
## 21
- EXP/FS Jack
1/4” TRS input, for connecting an external
expression pedal/footswitch controller.
- INPUT Jack
1/4” Mono input connection for guitar or other
instruments.
- AUX IN Jack
1/8” TRS input for connecting an audio player
and playing along (or recording).
- FX LOOP (SEND/RETURN) Jack
These 1/4” jacks can be used as FX loop for
inserting external stompboxes into your tone.
1 7.   UNBALANCED  OUTPUT  (L  for  mono
output)
Use 1/4” TS jacks cables to connect to your guitar
amp, full rang flat response (FRFR) speaker(s), or
other playback system.
When using a single amp or speaker, connect
only the L (MONO) jack.
- GND/LIFT Switch
Toggle off (up) the GND/LIFT switch to LIFT to
cut off the ground connection of the two XLR
connectors (Ground Lift) to avoid noise caused
by the Ground Loop. Toggle on (down) to GND,
the XLR line will be grounded normally.
- BALANCED  OUTPUT  (L  for  mono
output)
Use balanced XLR cables to connect to your
studio gear, mixer, PA, or FRFR speaker(s).
When using a single amp or speaker, connect
only the L (MONO) jack.
- PHONES Jack
...
- USB Jack
By connecting USB 2.0 Type-C to Mac and
Windows computers, GP-200 also functions
as a high quality audio interface with Direct
Injection (DI), Re-amping and MIDI functionality
built right in.
- POWER Switch
Turn the power on.
- DC 9V Jack
...
## Getting Started
## Getting Started
- Connect your device: Plug your guitar into the GP-200’s INPUT jack, and run a cable from the
...
-    Turn the GP-200 MASTER knob all the way down, then connect the power supply and turn on
the GP-200.
-    Tune your strings: Press and hold footswitch TAP (HOLD FOR TUNER) to enter Tuner interface.
...
G. Patch state
H. DRUM state
I. Current footswitch
setting
J.    Quick adjust paras
## TUNER
...
scale will change from red (out of tune) to yellow
...
## Tap
## Bank
1/2 SpeedDRUMTa p   Te m p oUndo
## Record/
## Playback
## Stop
## Back
HoldReverse/Tu n e rRedoClear
*Note:
...
## Hard Rock 1
## Hard Rock 2
Turn PARA to switch genres, click PARA to switch
Genre and Style.
GP-200 includes 100 drum patterns (check the
Drum Patterns list for details)
...
0dB
## E. GT
-   Input Mode: to adjust the impedance, including acoustic
...
## GLOBAL SETTINGS
## Wet
-   Rec Level: To control the master volume of the output when
...
Wet, the corresponding output channel will send out signals
...
- Set the Mono L and Mono R’s output to “Dry” in the Global Settings-USB Audio
- In the DAW, create two new Tracks A and B, and import/record a dry guitar Track in  A
- Set Track A output to Output 3-4, set Track B input to Input 3-4, keep Track B’s monitoring off
- Play the dry track in DAW, and now you can hear the effect sound of the processed dry track file
in GP-200
- Activate “Record” in Track B on the recording software, then you’ll get to record the Track with
...
computer
- In the DAW, create a new stereo audio track
- Set the input to Input 5-6
- Start recording in the DAW
- By playing other audio sources on your computer, you can record them in the track now
## Footswitch
...
mode and User mode. In each mode, all options are
...
footswitch. By fast-selecting which footswitch to
assign functions, tap the corresponding footswitch.
...
## Tap
## Patch
- Turn Quick Access Knob 1 to select tap functions
- Turn Quick Access Knob 2 to select hold functions
...
## Reset
## Patch
## FS 1+5FS 5+6FS 6+7FS 7+8
## Reset
NoneNoneNoneNone
We have a reset option in every mode to
perform a factory reset for all footswitches.
Footswitch functions include:
FunctionDescription
BankEnter bank selecting menu
B ank+
Load the latter adjacent
bank
## Bank-
Load the former adjacent
bank
## Patch+
Load the latter adjacent
patch
...
CLoad the C patch
DLoad the D patch
LOOPEREnter the Looper
FunctionDescription
DRUMPlay/stop the drum
## Drum Patch+
Load the latter adjacent
drum patch
## Drum Patch-
...
drum patch
## EXP 1 A/B
Switch between A/B of
## EXP 1
## MIDI
Enter the MIDI function
interface
TUNEREnter the tuner
## CTRL 1 ~ 8
Execute CTRL 1 - 8’s
function
Ta p   Te m p oUse Tap Tempo
EXP Calibrate
...
## EXP 1 CURVE
## Log
As shown, turn Quick Access Knob 1 or 2 to
calibrate EXP pedal 1 or 2. Knob 3 can select
the curve of EXP 1: Line, Expo, Log.
EXP Calibrate
Lift the pedal
fully up towards heel.
Press PARA to continue.
Lift your pedal all the way up, and click PARA to
continue.
...
Press PARA to continue.
Press strongly.
Press the pedal all the way down, and click
PARA to continue.
Press the front side strongly, and click
PARA to continue.
EXP Calibrate
Press PARA to continue.
## Complete!
...
## Failed!
EXP Calibrate
If successfully calibrated, the screen will
display as so.
If not, the screen will display as so. Please
try to repeat the process.You can also click
...
and you’ll need to manage the parameters in “Patch
Settings – EXP Settings”; if it is a single footswitch or
...
MIDI In Source
## Mixed
Input Ch(DIN)Input Ch(USB)
OmniOmni
This menu is to set up MIDI messages, including MIDI
...
-   MIDI In Source: Control where the MIDI message is
coming from.
...
ParametersRangeDescription
MIDI In Source
DIN OnlyOnly receiving MIDI messages from the MIDI IN.
USB OnlyOnly receiving MIDI messages from the USB.
MixedReceiving from both the MIDI IN and the USB.
Input Channel (DIN)
## Omni ~ 1 ~ 16
(The default
setting is Omni)
For setting up the channel of the USB input and the MIDI
messages’ input and output
## Input Channel
## (USB)
## Output Channel
...
## (USB)
## Clock Source
InternalOnly receiving from the internal clock
DIN Only
Only receiving the clock messages
from the MIDI IN
When “Din Only” , “USB
Only” or “External” is
selected, the internal
clock will not work and
the Tap Tempo will not
function
USB Only
Only receiving the clock messages
from the USB
## External
Only receiving from the external
clock
## Mixed
(Default)
Receiving clock messages from the internal clock, MIDI In
and USB. If using different clock sources simultaneously,
then the last message type the GP-200 receives will cover
previous ones
Clock Out (DIN)
## ON/OFF
(The default is
## OFF)
When turned ON, this unit will negate all input signals;
Additionally, when your Clock Source is set to “DIN Only” or
“USB Only”, this unit will not send out MIDI clock messages.
Clock Out (USB)
...
- Display Mode: Personalize the important
...
Global EQ
Band 4 FreqBand 4 QBand 4 Gain
EXP 2/ Footswitch
## Display
Global EQ
## Factory Reset
...
ON/OFFON/OFFOn/Off global EQ
Level0~100(Default: 50)
Adjust the master volume of the
global equalizer
## Low Cut
OFF~20Hz~20000Hz
(Default: OFF)
High pass filter to cut off low
frequency signals.
## High Cut
20Hz~20000Hz~OFF
(Default: 20000Hz)
Low pass filter to cut off high
frequency signals.
## Band 1-4: 4
selectable peak
filters used for
...
## 0.1~10.0
(Default: 0.71)
Width. To adjust the width of the
formant (slope of the filter), the
larger the number, the steeper
the slope.
## Band 1-4
## Gain
-20dB ~ +20dB
...
## Effect List
## PRE
FX TitleTyp eDescription Parameter Description
COMP  Comp
...
level compression effect.Clear sense
...
compressor starts to process the
signal
Volume: Controls the effect output
Clipping: Controls the input
sensitivity
S-CompComp
...
up to 20dB of gain, the Micro Boost
...
smooth sounding drive/boost pedal
...
The pedal works equally well for
getting thick and creamy overdrive
tones with great sustain as it does
for pushing the clean front end of an
...
and bass EQ controls, and imbue
...
Gain: Controls the gain amount
FAT BBBoost
This is a clean boost and pre-amp
with a switchable low-cut filter and
...
BoostBoost
Based on famous Xotic® EP
Booster* pedal. Provides +20DB
of pure stimulation lift, strong low
frequency, bright high frequency,
making clear sound more pleasant.
Volume: Controls the effect output/
boost amount
+3dB: Selects the minimum boost
amount from 0dB (off) to +3dB (on)
Bright: Selects the sound character
from vintage (Bright off) to flat
(Bright on)
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
The trademarks were used merely to identify the sound character of the products
...
today's top guitarists. The TS9 pedal
boosts the guitar signal enough to
drive the preamp stage of your amp,
...
you an authentic amp-in-a-box feel
with full, rich sound character that is
not harsh or boomy at all. Turn Gain
...
it gives your guitar the most
expression, makes it easy to control
the tone, and allows for subtle
...
bringing you a
more natural "woody" acoustic
sound
Shape: Controls the detailed effect
character
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
The trademarks were used merely to identify the sound character of the products
...
characteristics of a standard acoustic
guitar
...
auto wah effect for both guitars and
basses.
Depth: Controls the effect depth
Rate: Controls the effect speed
Volume: Controls the output level
Low: Controls the bottom point of
center frequency (low freq)
High: Controls the top point of center
frequency (high freq)
Q: Controls the sharpness of the filter
...
Sync: Switches Tap Tempo sync on/
off
OC TAPitchProvides polyphonic octave effect.
Oct 1: Controls the volume of lower
octave (1 oct down)
Oct 2: Controls the volume of higher
octave (1 oct up)
...
Assign the Position parameter to
...
max. one octave pitch shifting range.
...
to get the effect.
S-WahWah
Classic wah tone. Just press
down and feel the vocal sweep
and lush harmonics from the
wah's classic era. Its like keeping
a tiny jimi hendrix in your
pocket.
Range: Controls the wah filter frequency range
Q: Controls the wah resonance (filter Q)
Volume: Controls the effect output
...
remember to first assign the position
parameters, then turn on and press the pedal
to get the effect.B-WahWahWah designed for basses
HammyPitch
Based on classic Whammy®*
monophonic pitch shifter pedal.
Assign the Position parameter
to expression pedal, then move
the pedal to get the effect.
Range: Controls the pitch shifting range
Harmony: Switches Harmony mode (dry and
wet signals output simultaneously) on/off
...
## Effect List
## DST
FX TitleTyp eDescriptionParameter Description
Green ODOD
...
delicate overdrive effect.Can be
used as either an overdrive or a
Boost, can be used in a variety of
musical styles.
Gain: Controls the overdrive amount
Tone: Controls the effect tone
Volume: Controls the effect output
...
Volume: Controls the effect output
Scream ODOD
Based on Tube Screamer® Style
overdrive pedal, with unique timbre
characteristics.
Gain: Controls the overdrive amount
Volume: Controls the effect output
Tone: Controls the effect tone
...
amp. It produces overdriven
tones that sound warm and full,
with genuine tube-like response.
There’s no shortage of usable drive,
meaning it dynamically ramps up
overdriven grit from dirty overtones
to saturated distortion in the smooth
range of its drive control.
Gain: Controls the distortion amount
Tone: Controls the effect tone
Volume: Controls the effect output
Mode: Selects from two different
sound characters: HP (High Peak mode
with more bottom end and distortion),
LP (Low Peak mode without changing
your original tone)
Tu b eOD
Based on the legendary B. K.
## Butler® Tube Driver®*.
Gain: Controls the distortion amount
Volume: Controls the effect output
Bass/Treble: 2-band EQ that controls
...
overdrive and subtle boost are the
...
the perfect balance of saturation
and harmonics required to result in
all of the 'in-tangibles' that make
a pedal overdrive sound like a real
amp overdrive. Things like touch
...
overdrive. Perfect modern metal rig
with precise tonal carving controls.
The built-in noise gate ensures the
cleanness and clarity of tone.
Gain: Controls the overdrive amount
Tone: Controls the effect tone
Volume: Controls the effect output
...
threshold
Empire ODOD
Based on Analog.Man™ Prince of
Tone* Overload effect, multi-mode
selection, large tone adjustment
range to suit different scenes.
Gain: Controls the gain amount
Tone: Tone: Controls the effect tone
Volume: Controls the effect output
Mode: Select from 3 different modes
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
The trademarks were used merely to identify the sound character of the products
...
distortion pedal. It is very individual,
warm and thick sound wall, restless
but full of beauty.
...
with a few simple transistors. The
sound of Fuzz Face was heavy and
...
popular, and over the following
...
Distortion +*, and this M104-
based Plustortion. The Plustortion
...
during 4 years. This overdrive/
distortion Made in England effect
replicates the classic tube Marshall®
Amp sound into compact and solid
...
you can only get out of a Marshall.
...
controls the effect tone
La ChargerDistortion
Based on MI Audio® Crunch Box®*
distortion peal. Sensitive and
exquisite distortion beast, it satisfies
all the passion of Riff and Solo.The
response of each frequency band
is balanced, the dynamic feedback
...
## Dist
## Distortion
This model is based on a famous dirt
box recreating, perfect reproduction
of modern British high-gain timbre,
rich tunability, intuitive operation
to provide the perfect boost to your
music.
Gain: Controls the gain amount
Volume: Controls the effect output
Bass/Treble: 2-band EQ that controls
...
resonance
Flex ODBass Drive
A simple and effective distortion
effect for guitars and basses.
Gain: Controls the overdrive amount
Tone: Controls the effect tone
Volume: Controls the effect output
Mode: Selects from 3 different sound
characters: Normal (neutral sound),
...
band equalizer and a balanced line
driver for even greater versatility.
...
Blend: Controls the wet/dry signal ratio
Volume: Controls the effect output
Low/Lo-mid/Hi-mid/Treble: 2-band EQ
...
amount from 0dB (off) to +3dB (on)
Bright: Selects the sound character
from vintage (Bright off) to flat (Bright
on)
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
The trademarks were used merely to identify the sound character of the products
...
SnapTone
## 1-5
For importing and using the.nam file.
Gain: Controls the gain amount
Volume: Controls the output volume
(post gain)
Bass/Middle/Treble: 3-band EQ that
...
This amplifier with a dynamic range
from clean to wild overdrive, from
country rock to distortion, the
Fender® Tweed Deluxe* has been a
totem in every style for more than 60
years.
...
history of Rock&Roll, originally
designed for bass, has become the
most classic guitar speaker.As clear
as water, Vacuum tubemakes the
sound more beautiful,make musical
instrument manufacturers are eager
to imitate the product.
Gain: Controls the gain amount (pre
gain)
Presence: Controls the effect
headroom
...
Famous users: Stevie Ray Vaughan,
## Kurt Cobain
Bellman 59BDriveBased on Fender® ’59 Bassman®*.
Gain: Controls the gain amount (pre
gain)
Presence: Controls the effect
headroom
...
controls the effect tone
D ar k   Tw inClean
Based on Fender® ’65 Twin
Reverb®*. With a Stratocaster*, the
classic sound can be easily restored
in both country jazz and rock music.
Gain: Controls the gain amount (pre
gain)
Volume: Controls the output volume
(post gain)
...
The speaker lineup and the output
transformer were based on the
Fender Super amp of the time and the
circuit based on the Fender Vibrolux
of the time. The 40-watt amplifier
boasted two channels (NORMAL
and BRIGHT). Both channels had
...
amplifiers were built between 1967
and 1981. It makes the sound of
history.
Gain: Controls the gain amount (pre
gain)
Volume: Controls the output volume
...
and warm and sharp overdrive, since
the day of its birth, has become the
Shadows, The Beatles, the Rolling
Stones and other group's favorite
speaker. The British band led the
"British Invasion" has made VOX®
speaker a household name as a
British rock icon.Even in hard rock and
...
solid state combo. When it came
out in 1975, it is the first musical
instrument speaker equipped with
Chorus effect. It was famous for its
pure sound and stereo chorus effect.
Gain: Controls the effect gain/output
amount
Bright: Switches extra presence on/
off
Bass/Middle/Treble: 3-band EQ that
controls the effect tone
Match CLClean
## Based Matchless™ Chieftain 212
combo* (clean tone). MATCHLESS®'s
philosophy since its founding in 1989
has been to make as many top-notch,
all-purpose speakers as possible.The
crisp graininess and perfect dynamic
feedback will make your playing
easy.
Gain: Controls the gain amount (pre
gain)
Presence: Controls the effect
...
excellent circuit design makes it have
...
and roll sound. Its loud and handsome
...
is known for its fiery high gain
...
and dynamic range, it is not only an
...
PG20C* (Normal channel, bright off).
If you're a big fan of British sound/
overdrive, this is a sound you can't
miss.It can bring the pure British
...
Knights CL+Clean
Based on Grindrod® Pendragon
PG20C* (Normal channel, bright on).
If you're a big fan of British sound/
overdrive, this is a sound you can't
miss.It can bring the pure British
style, sound full of penetrating power.
...
Knights ODDrive
Based on Grindrod® Pendragon
PG20C* (Drive channel). If you're a
big fan of British sound/overdrive,
this is a sound you can't miss.It can
bring the pure British style, sound full
...
the sound quality has been greatly
...
Brown Sound, Steve Vai's classic
...
and its powerful sound laid the
...
controls the effect tone
UK 45+Drive
Based on Marshall® JTM45* . In 1962,
Marshall® introduced the first guitar
speakers specifically designed for
rock music, and its powerful sound
laid the foundation for rock music. So
its panel material  plexiglas as the
most classic 1960s sound specific
name--- Plexi.
Gain: Controls the gain amount (pre
gain)
Presence: Controls the effect
...
was improved. In 1966, Marshall
company launched JTM50*, and the
...
overdrive by more people. The timbre
is more full compared to JTM45*.
Gain 1/2: Controls the gain amount
(pre gain)
Presence: Controls the effect
headroom
Volume: Controls the output volume
...
if he could make it louder. This re-
...
founders named it after their own
...
JCM800® adding another channel,
two reverb options and two gain
features. Tube Set consists of 3
x 12AX7 preamp tubes, and 4 x
6L6/5881 power tubes.
Known for its tone and workhorse
roadworthiness, the JCM900 has
many fans due to its feature set and
versatility.
Gain: Controls the gain amount (pre
gain)
Presence: Controls the effect
...
Plexi* basis. It has smooth high
...
Rectifier(Vintage mode). The
distortion of Rectifier series is warm,
and the distortion of Rectifier series
is very wide, which is more thick and
solid than Mark.
Gain: Controls the gain amount (pre
gain)
Presence: Controls the effect
...
pure tube sound in the classic Class A
circuit (with 4 El84 amp tubes), which
guarantees harmonious sounds with
an impressive spectrum. The "TC"
stands for "twin channel", where
a lead channel available, ensuring
...
the 1980s, loved the sound and took
...
variety.
This incredible tonal flexibility comes
...
controls the effect tone
Power LDHi Gain
Based on ENGL® Powerball II
E645/2* (CH4). It can bring you
extremely compact low frequency,
a lot of gain and precise dynamic
response, which is very suitable for
...
Germany in the 1990s, its timbre
and multifunction have attracted
countless guitar masters.The unique
Modern Higain quickly conquered
many musicians.
Gain: Controls the gain amount (pre
gain)
Presence: Controls the effect
...
Bass/Middle/Treble: 3-band EQ that
controls the effect tone
Famous users: Guns N’ Roses,
METALLICA, KORN, Slipknot, BON
## JOVI
Dizz VH SHi Gain
Dizz VH+Hi Gain
Dizz VH+ SHi Gain
...
always been the most mainstream
...
amp. You can hear the sound of the
early bass speakers in many albums.
Gain: Controls the gain amount
Volume: Controls the output volume
(post gain)
Bass/Middle/Treble: 3-band EQ that
...
can be seen from the early clubs to
...
the extremely advanced adjustment
...
EQ Gain: Controls the EQ boost/cut
amount; set to 50 to keep neutral
SnapTone 1-5For importing and using the.nam file.
Gain: Controls the gain amount
Volume: Controls the output volume
(post gain)
Bass/Middle/Treble: 3-band EQ that
...
This novel improvement provides a
...
FX TitleTyp eDescriptionParameter Description
Gate 3Gate
The inverse expander is a type
of dynamic signal processing
algorithm.
Threshold: Controls the threshold for
triggering the effect
Ratio: Controls the ratio of the effect
Attack: Controls the attack time of
the effect
Release: Controls the release time of
the effect
Hold: Controls the hold time of the
effect
Hysteresis: Controls the threshold
for deactivating the effect with
hysteresis
Auto SwellSpecial
This is an auto swell effect with
two parameters that are easy to
...
high-frequency signal above the
selected
...
J-120 2 x 12”Legendary "Jazz Chorus" 2x12" cabinet
UK G12 1 x 12”Marshall®* 1x12" cabinet
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
The trademarks were used merely to identify the sound character of the products
...
FX TitleTyp eDescription
## Parameter Description
UK GRN 1 2 x 12”Marshall® 2550* 2x12" cabinet
Volume: Controls effect output
volume
Low Cut: Highpass filter, cut off
the low-frequency signal below
...
high-frequency signal above the
selected
UK LD 4 x 12”Marshall® 1960AV* 4x12" cabinet
UK TD 4 x 12”
## 68 Marshall® Basketweave* 4x12"
cabinet
UK MD 4 x 12”
...
EV 4 x 12”Peavey® 6505* 4x12" cabinet
Bog 4 x 12”Bogner®* 4x12" cabinet
Eagle 4 x 12”ENGL®* 4x12" cabinet
Uban 4 x 12”Bogner® Uberkab* 4x12" cabinet
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
The trademarks were used merely to identify the sound character of the products
...
FX TitleTyp eDescription
## Parameter Description
Solo 4 x 12”Soldano®* 4x12" caninet
Volume: Controls effect output
volume
Low Cut: Highpass filter, cut off
the low-frequency signal below
...
high-frequency signal above the
selected
Juice 4 x 12”Orange® PPC412* 4x12" cabinet
H -WAY 4 x 12”
...
M AT T 2 x 10”Mark Bass®* 4x10" bass cabinet
F -T OP 1 x 15”Ampeg® PF-115HE* 1x15" bass cabinet
AMPG 1 4 x 10”
Ampeg® SVT-410HE* 4x10" bass
cabinet
AMPG 2 8 x 10”Ampeg SVT-810E* 8x10" bass cabinet
HACK 4 x 12”Hartke®* 4x12" bass cabinet
ACAcousticDreadnought guitar simulation 1
AC DreamAcousticDreadnought guitar simulation 2
OMAcousticSimulates an OM type acoustic guitar
JUMBOAcousticSimulates a jumbo acoustic guitar
BirdAcoustic
Simulates the iconic "H-Bird" acoustic
guitar
GAAcousticSimulates a GA type acoustic guitar
Classic ACAcousticSimulates a classical guitar
MandolinAcousticSimulates a mandolon
Fretless BassAcousticSimulates a fretless acoustic bass
Double BassAcousticSimulates a double bass
User IR 1~20User IR
User IR 1~20
...
## Parameter Description
A-ChorusChorus
Based on the classic chorus
pedal of the 1980s. It can be
used to create tones similar to
the style of rotary speakers.
...
ensemble
chorus pedal born in late 1970s
(chorus mode), producing rich,
shimmering vintage analog
chorus tone. Warm, rich, and
dreamlike analog chorus
sound.
Depth: Controls the chorus depth
Rate: Controls the chorus rate
Volume: Controls the effect level
Sync: Switches Tap Tempo sync on/off
C- C ho r u sChorus
Based on a legendary 4-button
purple stereo chorus pedal,
providing detailed rich chorus
tone that expands sonic
dimensions
Mode: Select from 4 different chorus
modes
B-ChorusChorus
Based on the famous ensemble
chorus unit tuned for bassists
...
sync on/off
V-RotoVibrato
Based on a BBD-based blue
vibrato pedal, producing
...
Sync: Switches Tap Tempo sync on/off
G-PhasePhaser
Based on a BBD-based green
phase pedal, producing natural
analog phase sound
...
Trower and many more. The
rich “chorus” effect that
it’s famous for has become
a staple in a classic rock
guitarist’s rig. While the Uni-
Vibe’s construction is closely
...
Rate: Controls the effect speed
Volume: Controls the effect output
Mode: Select from 2 different vibe modes:
Chorus and Vibrato
Sync: Switches Tap Tempo sync on/off
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
The trademarks were used merely to identify the sound character of the products
...
Sync: Switches Tap Tempo sync on/off
S i n e   Tr e mTr e m o l o
Sine tremolo waveforms and
super wide tonal range.
Depth: Controls the effect depth
Rate: Controls the effect speed
Volume: Controls the effect output
Sync: Switches Tap Tempo sync on/off
B i a s   Tr e mTr e m o l o
Bias tremolo waveforms and
super wide tonal range
Depth: Controls the effect depth
Rate: Controls the effect speed
Volume: Controls the effect output
...
Detune: Controls the detune amount from
-50 to +50 cents
Bit SmashSpecial
Provides bitcrushing/sample
reducing effect with musical
fashion
...
Hi Cut: Controls the cutoff frequency of
the high cut filter
...
it playing when the effect
is activated. The Activate
parameter can be assigned
to the expression pedal to
activate and deactivate the
effect; You can also turn on the
...
the sound of a BBD based
analog delay machine that
is warm, smooth, rounded
due to the limitation of BBD
chips.
Mix: Controls the wet/dry signal ratio
...
FX TitleTyp eDescription
## Parameter Description
Digital Delay SDelay
This model is a stereo digital
delay that
produces a pure clean delay
sound, clear
and accurate.
Mix: Controls the wet/dry signal ratio
Feedback: Controls the amount of feedback
...
created delay and echo
effects using tape machines.
That sweet, space-like
echo tone is still popular
...
tap delay that brings
you expanded sound
spaciousness. 1, 2 stands for
...
Level: Controls the effect output
Mod: Controls the effect modulation
amount
Tone: Controls the effect tone
Sync: Switches Tap Tempo sync on/off
Trail: Switched effect trail on/off when the
...
effect is bypassed
Tap eDelay
A ping-pong delay producing
stereo feedbadk bounces
...
Swp Sync: Switches sweep filter Tap Tempo
sync on/off
...
effect is bypassed
M-EchoDelay
This analog delay pedal was
sold from 1981 to 1984 and
is still sought after thanks
to its warm, natural sound.
...
Analog Delay*, providing
warm, accurate delay sound.
100% Analog Delay, dynamic
distortion on Delay repeats,
gorgeous, warm, organic
delay tone.
Mix: Controls the wet/dry signal ratio
Feedback: Controls the amount of feedback
Time: Controls the delay time
...
Vintage RackDelay
Producing a delay effect
with lo-fi'd repeats
Mix: Controls the wet/dry signal ratio
Feedback: Controls the amount of feedback
Time: Controls the delay time
Crush: Controls the effect sampling rate
Bit: Controls the effect sampling accuracy
Sync: Switches Tap Tempo sync on/off
Trail: Switched effect trail on/off when the
effect is bypassed
Lofi EchoDelay
...
Time B: Controls the delay time of delay B
...
delay time by turning on
the Sync switch. When the
Sync switch is on, turn the
Time knob to set a proper
tap divide value. The default
value is 1/4 (no division).
Mix: Controls the wet/dry signal ratio
Time: Controls the delay time
Feedback: Controls the amount of feedback
Mod: Controls the effect modulation amount
...
Direction: Controls audio slice playback direction
...
effect is bypassed
Broken DelayDelay
This is a creative delay
effect focused on “breaking
conventions”. It produces
a “fragmented” sound
characterized by stutters,
jumps, and granularity,
simulating effects like
“signal glitches” or “device
freezes”.
Mix: Controls the wet/dry signal ratio
Time: Controls the delay time
Feedback: Controls the amount of feedback
Latch: Controls glitching length; 0=no glitch
Cut: Controls glitching speed; 0=no glitch
Sync: Switches Tap Tempo sync on/off
Trail: Switched effect trail on/off when the
effect is bypassed
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
...
Simulates the sound
character produced by a
vintage spring reverberator
Mix: Controls the wet/dry signal ratio
Decay: Controls the duration of reverb time
Tone: Controls the effect tone
Trail: Switched effect trail on/off when the
effect is bypassed
Tu b e   S p r i n gReverb
This reverb model
simulates the sound
coming from a vintage tube
driven spring reverb unit.
Mix: Controls the wet/dry signal ratio
Pre Delay: Controls the amount of time
between the dry signal and the audible onset
of early reflections and the reverb tail
Decay: Controls the duration of reverb time
Low Damp/Hi Damp: Dampens the effect low/
...
effect is bypassed
N-StarReverb
Special-tuned reverb effect
with lush, bright decays
Mix: Controls the wet/dry signal ratio
Decay: Controls the duration of reverb time
Trail: Switched effect trail on/off when the
effect is bypassed
...
## VOL
FX TitleTyp eDescription Parameter Description
VolumeVolumePure volume controlVolume: Controls output volume
*The manufacturers and product names mentioned above are trademarks or registered trademarks of their respective owners.
The trademarks were used merely to identify the sound character of the products
...
SnapTone Function
SnapTone Function
Software can load timbre files in NAM format in the AMP module and DST module.

## 71
## Drum Rhythm List
## Drum Rhythm List
GenreTyp eTime SignatureDefault Tempo
## Rock
## Classic Rock 14/4
## 120BPM
## Classic Rock 24/4
...
## 0-63: A
## 64-127: B
160-100Quick Access Para 1
## 170-127
Quick Access Knob 1 parameter adjustment:
0-63:Turn down by 1 step
64-127: Turn up by 1 step
180-100Quick Access Knob 2
## 190-127
Quick Access Knob 2 parameter adjustment:
0-63:Turn down by 1 step
64-127: Turn up by 1 step
200-100Quick Access Knob  3
## 210-127
Quick Access Knob 3 parameter adjustment:
0-63:Turn down by 1 step
64-127: Turn up by 1 step
220-127BANK - (initial mode)
230-127BANK + (initial mode)
240-127Patch -
250-127Patch +
260-127BANK - (wait mode)
270-127BANK +(wait mode)
280-127BANK (wait mode)
## 480-127
PRE Module on/off:
0-63: off
64-127: on
...
0-63: off
64-127: on
600-127LOOPER Record
610-127LOOPER Auto Record
## 620-127
Looper Play/Stop
## 0-63: Stop
## 64-127: Play
...
## 64-127: Normal
650-127Delete Loop
660-100Looper Recording Volume
670-100Looper Playback Volume
## 680-127
## Looper Placement
## 0-63: Rear
## 64-127: Front
...
## 710-127CTRL 3
## 720-127CTRL 4
730-1Tempo MSB, Used with Cc74
## 740-127
## CC73=0,CC74=40-127:
## 40BPM-127BPM
## CC73=1,CC74=0-122:
## 128BPM-250BPM
750-127Ta p   Te m p o
## 760-127CTRL  5
## 770-127CTRL  6
## 780-127CTRL  7
## 790-127CTRL  8
...
## 0-63: Stop
## 64-127: Play
940-99Drum Machine Type
950-100Drum Machine Volume
